...
@section('content')
                ...
                @if(isset($calendar))
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-row">
                                        <label>Add additional courts to the booking</label>
                                        <div class="form-group col-md-3">
                                            <label for="court1" class="col-form-label">Court 1</label>
                                            {{ Form::checkbox('court1', 'booked')}}
                                        </div><div class="form-group col-md-3">
                                            <label for="court2" class="col-form-label">Court 2</label>
                                            {{ Form::checkbox('court2', 'booked')}}
                                        </div><div class="form-group col-md-3">
                                            <label for="court3" class="col-form-label">Court 3</label>
                                            {{ Form::checkbox('court3', 'booked')}}
                                        </div><div class="form-group col-md-4">
                                            <label for="court4" class="col-form-label">Court 4</label>
                                            {{ Form::checkbox('court4', 'booked')}}
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-5">
                                    {!! CoralsForm::select('booking_owner','CourtBooking::attributes.booking.booking_owner', [], true, null,
                    ...
                    !!}
                                        ...
                                        <div class="form-group col-md-5">
                                            <label for="title" class="col-form-label">Practice Name:</label>
...
@section('footer')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            //var calendar = $('#calendar-courtbooking').fullCalendar('getCalendar');
